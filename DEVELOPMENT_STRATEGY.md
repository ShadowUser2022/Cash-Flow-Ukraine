...
### Етап 1: Основа (ПОТОЧНИЙ)

- [x] Базова архітектура
- [x] Правила гри документовані
- [x] Сервери налаштовані
...
## 🚫 ЗАБОРОНИ (Що НЕ робити)

### 1. НЕ змінювати базові правила

- НЕ змінювати умову фінансової свободи
- НЕ додавати треті кола
- НЕ змінювати кількість клітинок
- НЕ міняти основну механіку Cashflow

### 2. НЕ ускладнювати архітектуру

- НЕ створювати зайві абстракції
- НЕ дублювати логіку
- НЕ робити глибоку вкладеність компонентів
- НЕ ігнорувати TypeScript типи

### 3. НЕ порушувати фінансову логіку

- НЕ давати безкоштовні гроші
- НЕ робити нескінченні доходи
- НЕ ламати баланс професій
...
2. **Обговорити з командою** (якщо впливає на механіку)
3. **Оновити документацію** (якщо потрібно)
4. **Протестувати зміни**
5. **Оновити типи TypeScript**

### При виникненні суперечностей:

1. **Пріоритет**: Правила Cashflow
2. **Джерело істини**: Цей документ
3. **Обговорення**: Команда приймає рішення
4. **Документування**: Оновлюємо стратегію

---

## 🔗 Посилання на ключові документи

- **🤖 .github/instructions/AI_ASSISTANT.instructions.md** - Інструкції для AI асистента
- **📋 DEVELOPMENT_STRATEGY.md** - Цей документ (стратегія)
